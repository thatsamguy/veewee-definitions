Veewee::Session.declare({
  ...
  :boot_wait => "5",
  :boot_cmd_sequence => [ 'linux automatic=met:http,netw:dhcp,hos:veewee,ser:mirror.internode.on.net,dir:pub/mageia/distrib/2/x86_64, kickstart=http://%IP%:%PORT%/auto_inst.cfg<Enter>' ],
  :kickstart_port => "7122",
